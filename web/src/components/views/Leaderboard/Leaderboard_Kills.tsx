...
debugData([
    {
        action: 'setLeaderboardKillsPlayer',
        data: [
            {
                "deaths": 232,
                "kills": 7053,
...
export default function Leaderboard_Kills() {
    const [killsPlayer, setKillsPlayer] = useState<any>(null)
    useNuiEvent<any>('setLeaderboardKillsPlayer', (data) => {
        setKillsPlayer(data)
    })
    ...
    if (killsPlayer === null) {
        ...
        fetch(`https://YBN/YBN.Leaderboard:ReloadKills`, options)
    }
        ...
        <div className='flex flex-col h-screen max-h-screen w-screen max-w-screen select-none p-[4%] bg-black bg-opacity-50 bg-top bg-cover gap-[3.5%]'>
            ...
            <div className='flex flex-col justify-between gap-2 800:w-[550px] 1024:w-[650px] 1280:w-[675px] 1440:w-[700px] 1600:w-[725px] 1920:w-[775px] 2560:w-[800px] h-auto drop-shadow-md'>
                <h1 className='text-light-blue pb-[2%] uppercase 800:text-[8px] 1024:text-[10px] 1280:text-[12px] 1440:text-[14px] 1600:text-[16px] 1920:text-[18px] 2560:text-[20px] font-SFProDisplayMedium drop-shadow'>
                    <span className='border-l-2 p-[1%] px-[4%] border-light-blue bg-dark-blue'>Top Kills</span>
                </h1>
                            ...
                            return (
                                ...
                                >
                                    <div className='w-full h-full flex flex-row justify-start items-center pl-[1.3%]'>
                                        ...
                                        <h1 className='text-[#b1b1af] font-StratumMedium 800:text-[16px] 1024:text-[18px] 1280:text-[20px] 1440:text-[23px] 1600:text-[25px] 1920:text-[27px] 2560:text-[29px] w-[11%] text-right'>{priceToPriceWithCommase(player.kills)}</h1>
                                    </div>
                                </div>
                            )
                        })}
