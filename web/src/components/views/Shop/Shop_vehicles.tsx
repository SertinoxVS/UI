        ...
        data: [
            {
                ...
                "price": 10000,
                "type": "Muscle",
                "description": "Take the best-looking muscle car the 60's ever saw, and introduce it to the greatest American supercar of the modern era."
            },
        ]
    }
])
...
export default function Shop_vehicles() {
    const [shopData, setShopData] = useState<any>(null)
    useNuiEvent<any>('setShopDataVehicles', (data) => {
        setShopData(data)
    })
    ...
    return (
        <div className="flex flex-col h-screen max-h-screen w-screen max-w-screen select-none p-[5%] pt-[3%] bg-black bg-opacity-50 bg-center bg-cover gap-[1%]">
            ...
            <h1 className='text-black uppercase text-[10px] 800:text-[10px] 1024:text-[12px] 1280:text-[15px] 1440:text-[16px] 1600:text-[18px] 1920:text-[20px] 2560:text-[22px] rounded font-Countach'><span className='bg-extreme-light-grey px-[0.5%] pb-1 rounded-sm'>{languages["vehicles"]}</span></h1>
