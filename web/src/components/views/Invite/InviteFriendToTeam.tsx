...
export default function InviteFriendToTeam() {        
    ...
    const inviteTeam = () => {
        if (playersSelected.length > 0) {
            ...
            fetch(`https://YBN/YBN.Team:Invite`, options)
        } else {
    ...
    return (
        <div className='flex flex-col h-screen max-h-screen w-screen max-w-screen select-none p-[17%] pt-[5%] pb-[7%] bg-black bg-opacity-50 bg-top bg-cover items-center drop-shadow'>
            <h1 className='text-[#d8d7d7] font-SFProDisplaySemibold 800:text-[15px] 1024:text-[20px] 1280:text-[30px] 1600:text-[40px] 1920:text-[50px] 2560:text-[60px] drop-shadow uppercase'>INVITE TO Team</h1>
            <h6 className='text-[#acaba8] font-SFProDisplayMedium 800:text-[8px] 1024:text-[10px] 1280:text-[12px] 1600:text-[14px] 1920:text-[16px] 2560:text-[18px] drop-shadow'>Select players to invite to your team.</h6>
